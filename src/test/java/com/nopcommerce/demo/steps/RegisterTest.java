...
public class RegisterTest {
    ...
    public void iShouldSeeTheErrorMessageNextToEmailField(String email) {
    ...
    public void iShouldSeeTheErrorMessageNextToConfirmPasswordField(String confirmpassword) {
