Feature: Register Test
  ...
  Scenario: verify that user should create account successfully
    ...
    When  I click on register link
    And   I should navigate to registation page
    And   I enter "Harry" as firstname
    And   I enter "Patel" as lastname
    And   I select "22" day of birth
    And   I select "May" month of birth
    And   I select "1992" year of birth
    And   I enter  "harry2209@gmail.com" email address
    And   I enter "harry123" password as  password
    And   I enter  "harry123" as confirm password
    And   I click on register button
